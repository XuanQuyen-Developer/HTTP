...
echo $trang."= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =\n";
echo "$van \033[1;97mTool By:\033[1;93m Xuan Quyen\n";
echo "$van \033[1;97mZalo: zalo.me/quyentrumtool \n";
echo "$van \033[1;97mFacebook: https://m.facebook.com/dv.quyen \n";
...
echo "".$trang."[".$do."Delay".$trang."]--[".$vang.$m.$trang."]              \r";
usleep(30000);
echo "".$trang."[".$do."Delay".$trang."]----[".$vang.$m.$trang."]            \r";
usleep(30000);
echo "".$trang."[".$do."Delay".$trang."]------[".$vang.$m.$trang."]          \r";
